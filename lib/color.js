...
class Color {
	...
	static GetSengledMaxColorTemperature() {
		return sengledMaxColorTemperature;
	}

	static GetSengledMinColorTemperature() {
		return sengledMinColorTemperature;
	}
	...
	static SengledColorTemperatureToMireds(colorTemperature, configData) {
		...
		return Math.round(scaleRange(
			colorTemperature,
			this.GetSengledMinColorTemperature(),
			this.GetSengledMaxColorTemperature(),
